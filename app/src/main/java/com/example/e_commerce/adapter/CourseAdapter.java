...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View courseItems = LayoutInflater.from(context).inflate(R.layout.course_item, parent, false); //для всех наших элементов будет использован один дизайн
        return new CourseAdapter.CourseViewHolder(courseItems);
    }

    @Override
    public void onBindViewHolder(@NonNull CourseViewHolder holder, int position) //подставление значений через этот метод
    {
